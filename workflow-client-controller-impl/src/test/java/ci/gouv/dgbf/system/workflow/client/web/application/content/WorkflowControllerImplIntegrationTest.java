package ci.gouv.dgbf.system.workflow.client.web.application.content;
...
public class WorkflowControllerImplIntegrationTest extends AbstractIntegrationTest {
	...
	public void createWorkflowByManualPost(){
		...
		ResteasyWebTarget target = client.target(UriBuilder.fromPath(/*contextPath.toExternalForm()*/"http://localhost:8081/"+"workflow/create"));
